...
### Number 1 - How many breweries in each state?
```{r}
#ordered plot
...
### Number 3 - How many NAs and where they are
```{r}
...
### Number 5 - Top 5 States with Highest IBU
```{r}
...
### Number 5 - Top 5 States with Highest ABV
```{r}
...
### Number 8 - Loop for many k and the average of many training / test partition
```{r}
iterations = 100
numks = 50
...
### Number 8 - KNN model using best k value
```{r}
...
### Test models using ABV & IBU individually and together
```{r}
...
### Number 9 - Find any interesting relationships in the data
```{r}
