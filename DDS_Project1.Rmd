...
geom_bar(width = 1, stat = "identity") + xlab("") + ylab("") + ggtitle("Proportion Missing ABV Data")
...
geom_bar(width = 1, stat = "identity") + xlab("") + ylab("") + ggtitle("Proportion Missing IBU Data")
