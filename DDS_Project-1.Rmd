...
# Number 8b - Loop for many k and the average of many training / test partition
```{r}
iterations = 100
numks = 50
...
# Number 8c - KNN model using best k value
```{r}
...
# Number 8d - Test models using ABV & IBU individually and together
```{r}
...
# Number 9a - Find any interesting relationships in the data
```{r}
